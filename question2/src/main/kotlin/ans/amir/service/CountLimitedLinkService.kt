...
@Service
class CountLimitedLinkService(private val repository: CountLimitedLinkRepository) : LinkService<Long> {
    override fun validate(hash: String, limitation: Long): Boolean {
        val limitedLink = repository.findByLinkHash(hash) ?: return false
